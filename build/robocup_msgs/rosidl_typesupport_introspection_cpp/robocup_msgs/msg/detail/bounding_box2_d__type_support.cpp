...
{
  new (message_memory) robocup_msgs::msg::BoundingBox2D(_init);
}

void BoundingBox2D_fini_function(void * message_memory)
{
  auto typed_message = static_cast<robocup_msgs::msg::BoundingBox2D *>(message_memory);
  typed_message->~BoundingBox2D();
}

static const ::rosidl_typesupport_introspection_cpp::MessageMember BoundingBox2D_message_member_array[3] = {
  {
    "center",  // name
    ...
    offsetof(robocup_msgs::msg::BoundingBox2D, center),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(robocup_msgs::msg::BoundingBox2D, size_x),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(robocup_msgs::msg::BoundingBox2D, size_y),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers BoundingBox2D_message_members = {
  ...
  3,  // number of fields
  sizeof(robocup_msgs::msg::BoundingBox2D),
...
get_message_type_support_handle<robocup_msgs::msg::BoundingBox2D>()
{
  return &::robocup_msgs::msg::rosidl_typesupport_introspection_cpp::BoundingBox2D_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, robocup_msgs, msg, BoundingBox2D)() {
  return &::robocup_msgs::msg::rosidl_typesupport_introspection_cpp::BoundingBox2D_message_type_support_handle;
}
