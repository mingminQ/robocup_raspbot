...
#include "robocup_msgs/msg/detail/bounding_box2_d__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const robocup_msgs::msg::BoundingBox2D & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  robocup_msgs::msg::BoundingBox2D & ros_message)
{
  // Member: center
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = robocup_msgs::msg::BoundingBox2D;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const robocup_msgs::msg::BoundingBox2D *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<robocup_msgs::msg::BoundingBox2D *>(
    untyped_ros_message);
...
{
  return &robocup_msgs::msg::typesupport_fastrtps_cpp::_BoundingBox2D__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, robocup_msgs, msg, BoundingBox2D)() {
  return &robocup_msgs::msg::typesupport_fastrtps_cpp::_BoundingBox2D__handle;
}
