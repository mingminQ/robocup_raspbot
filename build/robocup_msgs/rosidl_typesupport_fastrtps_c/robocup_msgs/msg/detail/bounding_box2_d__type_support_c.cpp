...
#include "robocup_msgs/msg/detail/bounding_box2_d__rosidl_typesupport_fastrtps_c.h"
...
#include "geometry_msgs/msg/detail/pose2_d__functions.h"  // center
...
using _BoundingBox2D__ros_msg_type = robocup_msgs__msg__BoundingBox2D;
...
static uint32_t _BoundingBox2D__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_robocup_msgs__msg__BoundingBox2D(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = robocup_msgs__msg__BoundingBox2D;
    is_plain =
      (
...
static size_t _BoundingBox2D__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_robocup_msgs__msg__BoundingBox2D(
