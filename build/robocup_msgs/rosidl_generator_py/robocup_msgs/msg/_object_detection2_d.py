...
class Metaclass_ObjectDetection2D(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from robocup_msgs.msg import BoundingBox2D
...
class ObjectDetection2D(metaclass=Metaclass_ObjectDetection2D):
    ...
    _fields_and_field_types = {
        ...
        'label': 'string',
        'score': 'double',
        'bounding_box': 'robocup_msgs/BoundingBox2D',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.NamespacedType(['robocup_msgs', 'msg'], 'BoundingBox2D'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from robocup_msgs.msg import BoundingBox2D
        self.bounding_box = kwargs.get('bounding_box', BoundingBox2D())
    ...
    def bounding_box(self, value):
        if __debug__:
            ...
            assert \
                ...
                "The 'bounding_box' field must be a sub message of type 'BoundingBox2D'"
