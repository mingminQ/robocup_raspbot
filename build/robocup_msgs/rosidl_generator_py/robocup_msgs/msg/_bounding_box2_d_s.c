...
bool robocup_msgs__msg__bounding_box2_d__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("robocup_msgs.msg._bounding_box2_d.BoundingBox2D", full_classname_dest, 47) == 0);
  }
  robocup_msgs__msg__BoundingBox2D * ros_message = _ros_message;
  {  // center
    PyObject * field = PyObject_GetAttrString(_pymsg, "center");
    if (!field) {
      return false;
    }
    if (!geometry_msgs__msg__pose2_d__convert_from_py(field, &ros_message->center)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
...
PyObject * robocup_msgs__msg__bounding_box2_d__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("robocup_msgs.msg._bounding_box2_d");
  ...
  {  // center
    PyObject * field = NULL;
    field = geometry_msgs__msg__pose2_d__convert_to_py(&ros_message->center);
    if (!field) {
      return NULL;
    }
    {
